...
/// Render one parsed type using this exact format model and signature renderer.
pub fn type_rendering(krate: &rustdoc_types::Crate, value: &rustdoc_types::Type) -> String {
    render::type_rendering(krate, value)
}

/// Render declared generics without parsing or splitting a rendered signature.
pub fn generics_rendering(krate: &rustdoc_types::Crate, value: &rustdoc_types::Generics) -> String {
    render::generics_rendering(krate, value)
}
