...
| R-10 | `AGENTS.md` and `.claude/commands/acceptance-report.md` say 46 acceptance IDs; `tests/gates.toml` and `STATUS.md` say 48. The two extras are P08a and P08b, registered by ADR-0005 against a frozen plan that has 46 | ADR-0005 | any further gate registration or retirement, which widens the gap again | $ `grep -c '^\[gates\.' tests/gates.toml` | paul-heyse | 2026-09-13 | 2026-11-15 | open |
