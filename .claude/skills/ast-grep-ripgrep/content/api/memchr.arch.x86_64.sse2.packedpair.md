# `memchr::arch::x86_64::sse2::packedpair`

Crate `memchr` · 1 public items · structured records in [`model/memchr.arch.x86_64.sse2.packedpair.json`](../model/memchr.arch.x86_64.sse2.packedpair.json)
