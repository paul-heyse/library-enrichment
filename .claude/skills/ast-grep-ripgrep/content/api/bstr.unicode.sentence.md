# `bstr::unicode::sentence`

Crate `bstr` · 2 public items · structured records in [`model/bstr.unicode.sentence.json`](../model/bstr.unicode.sentence.json)

## SentenceIndices

`struct` · `bstr::unicode::sentence::SentenceIndices`

Also reachable as `bstr::SentenceIndices`

```rust
struct SentenceIndices<'a>
```
...
`struct` · `bstr::unicode::sentence::Sentences`

Also reachable as `bstr::Sentences`
