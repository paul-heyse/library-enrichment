# `regex::builders::bytes`

Crate `regex` · 2 public items · structured records in [`model/regex.builders.bytes.json`](../model/regex.builders.bytes.json)

## RegexBuilder

`struct` · `regex::builders::bytes::RegexBuilder`
...
`struct` · `regex::builders::bytes::RegexSetBuilder`
