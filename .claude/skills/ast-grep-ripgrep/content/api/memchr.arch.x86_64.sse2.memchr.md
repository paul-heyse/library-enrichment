# `memchr::arch::x86_64::sse2::memchr`

Crate `memchr` · 6 public items · structured records in [`model/memchr.arch.x86_64.sse2.memchr.json`](../model/memchr.arch.x86_64.sse2.memchr.json)
...
`struct` · `memchr::arch::x86_64::sse2::memchr::ThreeIter`
