...
class Method:
    ...
    via_trait: str | None
    owner: str
    # How a caller reaches this method. Populated by build.py from visibility.py; the family's
    # other repositories leave it at the default, where every documented method is reachable.
    visibility: str = "supported"
...
class Item:
    ...
    # See Method.visibility. `reached_via` names the call that hands you an item you cannot
    # write a path to; it is empty for everything a caller can simply `use`.
    visibility: str = "supported"
    reached_via: str = ""
