# `ruff_text_size::traits`

Crate `ruff_text_size` · 3 public items · structured records in [`model/ruff_text_size.traits.json`](../model/ruff_text_size.traits.json)

## Ranged

`trait` · `ruff_text_size::traits::Ranged`

Also reachable as `ruff_text_size::Ranged`
...
- `alloc::sync::Arc`
- `pyrefly::alt::callable::CallArg`
- `pyrefly::alt::callable::CallKeyword`
- `pyrefly::alt::expr::TypeOrExpr`
- `pyrefly::binding::base_class::BaseClass`
- `pyrefly::binding::base_class::BaseClassExpr`
- `pyrefly::binding::base_class::BaseClassGeneric`
...
- `pyrefly::binding::bindings::LegacyTParamId`
- `pyrefly::error::error::Error`
- `pyrefly_python::short_identifier::ShortIdentifier`
- `ruff_db::files::FileRange`
- `ruff_diagnostics::edit::Edit`
- `ruff_formatter::source_code::SourceCodeSlice`
- `ruff_python_ast::expression::LiteralExpressionRef`
- `ruff_python_ast::expression::StringLike`
- `ruff_python_ast::expression::StringLikePart`
...
- `ruff_python_ast::nodes::AnyParameterRef`
- `ruff_python_ast::nodes::ArgOrKeyword`
...
- `ruff_python_ast::script::ScriptTag`
- `ruff_python_ast::stmt_if::IfElifBranch`
- `ruff_python_ast::token::Token`
- `ruff_python_parser::error::ParseError`
- `ruff_python_parser::error::UnsupportedSyntaxError`
- `ruff_python_parser::semantic_errors::SemanticSyntaxError`
- `ruff_python_semantic::binding::Binding`
- `ruff_python_semantic::definition::Member`
- `ruff_python_semantic::model::ImportedName`
- `ruff_python_semantic::model::all::DunderAllDefinition`
- `ruff_python_semantic::model::all::DunderAllName`
- `ruff_python_semantic::nodes::NodeRef`
- `ruff_python_semantic::reference::ResolvedReference`
- `ruff_python_trivia::tokenizer::SimpleToken`
...
`trait` · `ruff_text_size::traits::TextLen`
...
`trait` · `ruff_text_size::traits::TextSlice`
