...
Crate `pyrefly_util` · 2 public items · structured records in [`model/pyrefly_util.visit.json`](../model/pyrefly_util.visit.json)

## Visit

`trait` · `pyrefly_util::visit::Visit`

```rust
trait Visit<To = Self>: Sized
```
...
`trait` · `pyrefly_util::visit::VisitMut`
