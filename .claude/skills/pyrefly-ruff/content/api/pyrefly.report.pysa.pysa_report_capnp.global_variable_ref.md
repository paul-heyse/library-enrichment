# `pyrefly::report::pysa::pysa_report_capnp::global_variable_ref`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.global_variable_ref.json`](../model/pyrefly.report.pysa.pysa_report_capnp.global_variable_ref.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::global_variable_ref::Builder`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::global_variable_ref::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::global_variable_ref::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::global_variable_ref::Reader`
