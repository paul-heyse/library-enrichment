# `pyrefly::report::pysa::pysa_report_capnp::function_base_definition`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.function_base_definition.json`](../model/pyrefly.report.pysa.pysa_report_capnp.function_base_definition.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_base_definition::Builder`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_base_definition::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_base_definition::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_base_definition::Reader`
