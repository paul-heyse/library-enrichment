# `pyrefly::report::pysa::pysa_report_capnp::decorator_callee`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.decorator_callee.json`](../model/pyrefly.report.pysa.pysa_report_capnp.decorator_callee.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::decorator_callee::Builder`
...
fn get_targets(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a, pysa_report_capnp::target::Owned>>
fn has_location(&self) -> bool
fn has_targets(&self) -> bool
fn init_location(self) -> pysa_report_capnp::pysa_location::Builder<'a>
fn init_targets(self, size: u32) -> ::capnp::struct_list::Builder<'a, pysa_report_capnp::target::Owned>
...
fn set_targets(&mut self, value: ::capnp::struct_list::Reader<'_, pysa_report_capnp::target::Owned>) -> ::capnp::Result<()>
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::decorator_callee::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::decorator_callee::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::decorator_callee::Reader`
...
fn get_targets(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a, pysa_report_capnp::target::Owned>>
fn has_location(&self) -> bool
fn has_targets(&self) -> bool
