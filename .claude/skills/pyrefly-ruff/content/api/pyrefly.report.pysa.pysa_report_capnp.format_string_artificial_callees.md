# `pyrefly::report::pysa::pysa_report_capnp::format_string_artificial_callees`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.format_string_artificial_callees.json`](../model/pyrefly.report.pysa.pysa_report_capnp.format_string_artificial_callees.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::format_string_artificial_callees::Builder`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::format_string_artificial_callees::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::format_string_artificial_callees::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::format_string_artificial_callees::Reader`
