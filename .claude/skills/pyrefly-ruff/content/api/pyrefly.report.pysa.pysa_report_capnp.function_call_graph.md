# `pyrefly::report::pysa::pysa_report_capnp::function_call_graph`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.function_call_graph.json`](../model/pyrefly.report.pysa.pysa_report_capnp.function_call_graph.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_call_graph::Builder`
...
```rust
fn get_entries(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a, pysa_report_capnp::call_graph_entry::Owned>>
fn get_function_id(self) -> ::capnp::Result<::capnp::text::Builder<'a>>
fn has_entries(&self) -> bool
fn has_function_id(&self) -> bool
fn init_entries(self, size: u32) -> ::capnp::struct_list::Builder<'a, pysa_report_capnp::call_graph_entry::Owned>
...
fn set_entries(&mut self, value: ::capnp::struct_list::Reader<'_, pysa_report_capnp::call_graph_entry::Owned>) -> ::capnp::Result<()>
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_call_graph::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_call_graph::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_call_graph::Reader`
...
```rust
fn get_entries(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a, pysa_report_capnp::call_graph_entry::Owned>>
