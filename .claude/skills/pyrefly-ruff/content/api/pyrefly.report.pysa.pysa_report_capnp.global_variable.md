# `pyrefly::report::pysa::pysa_report_capnp::global_variable`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.global_variable.json`](../model/pyrefly.report.pysa.pysa_report_capnp.global_variable.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::global_variable::Builder`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::global_variable::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::global_variable::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::global_variable::Reader`
