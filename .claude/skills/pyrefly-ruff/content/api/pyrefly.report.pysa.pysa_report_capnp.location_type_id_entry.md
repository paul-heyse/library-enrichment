# `pyrefly::report::pysa::pysa_report_capnp::location_type_id_entry`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.location_type_id_entry.json`](../model/pyrefly.report.pysa.pysa_report_capnp.location_type_id_entry.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::location_type_id_entry::Builder`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::location_type_id_entry::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::location_type_id_entry::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::location_type_id_entry::Reader`
