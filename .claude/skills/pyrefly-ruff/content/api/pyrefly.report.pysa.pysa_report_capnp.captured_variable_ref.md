# `pyrefly::report::pysa::pysa_report_capnp::captured_variable_ref`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.captured_variable_ref.json`](../model/pyrefly.report.pysa.pysa_report_capnp.captured_variable_ref.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::captured_variable_ref::Builder`
...
fn get_outer_function(self) -> ::capnp::Result<pysa_report_capnp::function_ref::Builder<'a>>
fn has_name(&self) -> bool
fn has_outer_function(&self) -> bool
fn init_name(self, size: u32) -> ::capnp::text::Builder<'a>
fn init_outer_function(self) -> pysa_report_capnp::function_ref::Builder<'a>
...
fn set_outer_function(&mut self, value: pysa_report_capnp::function_ref::Reader<'_>) -> ::capnp::Result<()>
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::captured_variable_ref::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::captured_variable_ref::Pipeline`
...
```rust
fn get_outer_function(&self) -> pysa_report_capnp::function_ref::Pipeline
```
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::captured_variable_ref::Reader`
...
fn get_outer_function(self) -> ::capnp::Result<pysa_report_capnp::function_ref::Reader<'a>>
fn has_name(&self) -> bool
fn has_outer_function(&self) -> bool
