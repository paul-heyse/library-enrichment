# `pyrefly_types::equality`

Crate `pyrefly_types` · 2 public items · structured records in [`model/pyrefly_types.equality.json`](../model/pyrefly_types.equality.json)

## TypeEqCtx

`struct` · `pyrefly_types::equality::TypeEqCtx`
...
`trait` · `pyrefly_types::equality::TypeEq`
