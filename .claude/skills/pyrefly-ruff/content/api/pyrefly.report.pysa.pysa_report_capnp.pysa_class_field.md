# `pyrefly::report::pysa::pysa_report_capnp::pysa_class_field`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.pysa_class_field.json`](../model/pyrefly.report.pysa.pysa_report_capnp.pysa_class_field.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::pysa_class_field::Builder`
...
```rust
fn get_declaration_kind(self) -> ::core::result::Result<pysa_report_capnp::PysaClassFieldDeclaration, ::capnp::NotInSchema>
fn get_explicit_annotation(self) -> ::capnp::Result<::capnp::text::Builder<'a>>
...
fn get_type(self) -> ::capnp::Result<pysa_report_capnp::pysa_type::Builder<'a>>
fn has_explicit_annotation(&self) -> bool
fn has_location(&self) -> bool
fn has_name(&self) -> bool
fn has_type(&self) -> bool
fn init_explicit_annotation(self, size: u32) -> ::capnp::text::Builder<'a>
fn init_location(self) -> pysa_report_capnp::pysa_location::Builder<'a>
fn init_name(self, size: u32) -> ::capnp::text::Builder<'a>
fn init_type(self) -> pysa_report_capnp::pysa_type::Builder<'a>
fn into_reader(self) -> Reader<'a>
fn reborrow(&mut self) -> Builder<'_>
fn reborrow_as_reader(&self) -> Reader<'_>
fn set_declaration_kind(&mut self, value: pysa_report_capnp::PysaClassFieldDeclaration)
fn set_explicit_annotation(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)
...
fn set_type(&mut self, value: pysa_report_capnp::pysa_type::Reader<'_>) -> ::capnp::Result<()>
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::pysa_class_field::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::pysa_class_field::Pipeline`
...
fn get_type(&self) -> pysa_report_capnp::pysa_type::Pipeline
```
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::pysa_class_field::Reader`
...
```rust
fn get_declaration_kind(self) -> ::core::result::Result<pysa_report_capnp::PysaClassFieldDeclaration, ::capnp::NotInSchema>
fn get_explicit_annotation(self) -> ::capnp::Result<::capnp::text::Reader<'a>>
...
fn get_type(self) -> ::capnp::Result<pysa_report_capnp::pysa_type::Reader<'a>>
fn has_explicit_annotation(&self) -> bool
fn has_location(&self) -> bool
fn has_name(&self) -> bool
fn has_type(&self) -> bool
