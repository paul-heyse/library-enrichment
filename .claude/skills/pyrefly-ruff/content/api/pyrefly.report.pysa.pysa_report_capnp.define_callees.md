# `pyrefly::report::pysa::pysa_report_capnp::define_callees`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.define_callees.json`](../model/pyrefly.report.pysa.pysa_report_capnp.define_callees.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::define_callees::Builder`
...
```rust
fn get_define_targets(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a, pysa_report_capnp::pysa_call_target::Owned>>
fn has_define_targets(&self) -> bool
fn init_define_targets(self, size: u32) -> ::capnp::struct_list::Builder<'a, pysa_report_capnp::pysa_call_target::Owned>
fn into_reader(self) -> Reader<'a>
fn reborrow(&mut self) -> Builder<'_>
fn reborrow_as_reader(&self) -> Reader<'_>
fn set_define_targets(&mut self, value: ::capnp::struct_list::Reader<'_, pysa_report_capnp::pysa_call_target::Owned>) -> ::capnp::Result<()>
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::define_callees::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::define_callees::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::define_callees::Reader`
...
```rust
fn get_define_targets(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a, pysa_report_capnp::pysa_call_target::Owned>>
fn has_define_targets(&self) -> bool
