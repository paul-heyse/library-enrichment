# `pyrefly::report::pysa::pysa_report_capnp::module_type_of_expressions`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.module_type_of_expressions.json`](../model/pyrefly.report.pysa.pysa_report_capnp.module_type_of_expressions.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::module_type_of_expressions::Builder`
...
```rust
fn get_functions(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a, pysa_report_capnp::function_type_of_expressions::Owned>>
...
fn init_functions(self, size: u32) -> ::capnp::struct_list::Builder<'a, pysa_report_capnp::function_type_of_expressions::Owned>
...
fn set_functions(&mut self, value: ::capnp::struct_list::Reader<'_, pysa_report_capnp::function_type_of_expressions::Owned>) -> ::capnp::Result<()>
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::module_type_of_expressions::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::module_type_of_expressions::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::module_type_of_expressions::Reader`
...
```rust
fn get_functions(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a, pysa_report_capnp::function_type_of_expressions::Owned>>
fn get_module_id(self) -> u32
