# `pyrefly::report::pysa::pysa_report_capnp::type_errors`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.type_errors.json`](../model/pyrefly.report.pysa.pysa_report_capnp.type_errors.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::type_errors::Builder`
...
```rust
fn get_errors(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a, pysa_report_capnp::type_error::Owned>>
fn has_errors(&self) -> bool
fn init_errors(self, size: u32) -> ::capnp::struct_list::Builder<'a, pysa_report_capnp::type_error::Owned>
fn into_reader(self) -> Reader<'a>
fn reborrow(&mut self) -> Builder<'_>
fn reborrow_as_reader(&self) -> Reader<'_>
fn set_errors(&mut self, value: ::capnp::struct_list::Reader<'_, pysa_report_capnp::type_error::Owned>) -> ::capnp::Result<()>
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::type_errors::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::type_errors::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::type_errors::Reader`
...
```rust
fn get_errors(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a, pysa_report_capnp::type_error::Owned>>
fn has_errors(&self) -> bool
