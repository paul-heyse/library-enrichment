# `pyrefly::report::pysa::pysa_report_capnp::function_ref`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.function_ref.json`](../model/pyrefly.report.pysa.pysa_report_capnp.function_ref.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_ref::Builder`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_ref::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_ref::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_ref::Reader`
