# `pyrefly::report::pysa::pysa_report_capnp::scope_parent`

Crate `pyrefly` · 5 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.scope_parent.json`](../model/pyrefly.report.pysa.pysa_report_capnp.scope_parent.json)

## Which

`enum` · `pyrefly::report::pysa::pysa_report_capnp::scope_parent::Which`

```rust
enum Which
```

**Variants**: `Function`, `Class`, `TopLevel`

---

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::scope_parent::Builder`
...
fn set_class(&mut self, value: u32)
fn set_function(&mut self, value: u32)
fn set_top_level(&mut self, _value: ())
fn total_size(&self) -> ::capnp::Result<::capnp::MessageSize>
fn which(self) -> ::core::result::Result<Which, ::capnp::NotInSchema>
```
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::scope_parent::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::scope_parent::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::scope_parent::Reader`
