# `pyrefly::report::pysa::pysa_report_capnp::function_parameter::kw_only_param`

Crate `pyrefly` · 4 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.function_parameter.kw_only_param.json`](../model/pyrefly.report.pysa.pysa_report_capnp.function_parameter.kw_only_param.json)

## Builder

`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_parameter::kw_only_param::Builder`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_parameter::kw_only_param::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_parameter::kw_only_param::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::function_parameter::kw_only_param::Reader`
