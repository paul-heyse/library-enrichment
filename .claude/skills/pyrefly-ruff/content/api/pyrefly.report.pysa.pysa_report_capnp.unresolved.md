# `pyrefly::report::pysa::pysa_report_capnp::unresolved`

Crate `pyrefly` · 5 public items · structured records in [`model/pyrefly.report.pysa.pysa_report_capnp.unresolved.json`](../model/pyrefly.report.pysa.pysa_report_capnp.unresolved.json)

## Which

`enum` · `pyrefly::report::pysa::pysa_report_capnp::unresolved::Which`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::unresolved::Builder`
...
fn set_false(&mut self, _value: ())
fn set_true(&mut self, value: pysa_report_capnp::UnresolvedReason)
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::unresolved::Owned`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::unresolved::Pipeline`
...
`struct` · `pyrefly::report::pysa::pysa_report_capnp::unresolved::Reader`
