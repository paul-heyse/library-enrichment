...
## Already using another type checker?

Pyrefly reads your existing mypy or Pyright configuration, so switching starts with a single command.

- [Compare Python type checkers](compare.mdx) - what Pyrefly gives you over mypy and Pyright
- [Migrate from mypy](migrate/mypy/index.mdx) - convert a mypy config and roll Pyrefly out incrementally
- [Migrate from Pyright](migrate/pyright/index.mdx) - convert a `pyrightconfig.json` and review the diagnostic mapping
