...
`pyrefly_util::visit::Visit`

```rust
trait Visit<To = Self>: Sized
```

Prose: [`api/pyrefly_util.visit.md`](../api/pyrefly_util.visit.md#visit) · records: [`model/pyrefly_util.visit.json`](../model/pyrefly_util.visit.json)
