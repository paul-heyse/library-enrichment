...
`ruff_python_formatter::shared_traits::IntoFormat`
...
Prose: [`api/ruff_python_formatter.shared_traits.md`](../api/ruff_python_formatter.shared_traits.md#intoformat) · records: [`model/ruff_python_formatter.shared_traits.json`](../model/ruff_python_formatter.shared_traits.json)
