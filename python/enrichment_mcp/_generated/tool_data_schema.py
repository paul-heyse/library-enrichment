...
class ConfigurationDifference9(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    after: str | None
...
class ConfigurationDifference10(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    after: list[str] | None
...
class ConfigurationDifference11(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    after: bool | None
...
class ConfigurationDifference12(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    after: str | None
...
class ConfigurationDifference13(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    after: After = Field(
...
class ExecutionTarget7(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class MatchCount4(RootModel[MatchCount | MatchCount6 | MatchCount7]):
    root: MatchCount | MatchCount6 | MatchCount7 = Field(
...
class ProcessAuthority5(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ProcessAuthority3(RootModel[ProcessAuthority | ProcessAuthority5]):
    root: ProcessAuthority | ProcessAuthority5 = Field(
...
class ResearchRequest22(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchRequest28(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchRequest30(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchSelection5(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResolveRequest(BaseModel):
    ...
    ecosystem: Ecosystem8 = Field(..., description="Which ecosystem.")
    ...
    freshness: Freshness = Field(..., description="Freshness policy for this call.")
    mode: Mode8 | None = Field(
        ...,
...
class RustBody3(RootModel[RustBody | RustBody5]):
    root: RustBody | RustBody5 = Field(
        ...,
...
class RustStabilityLevel3(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    kind: Literal["stable"]
...
class RustStabilityLevel4(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class RustStabilityLevel(RootModel[RustStabilityLevel3 | RustStabilityLevel4]):
    root: RustStabilityLevel3 | RustStabilityLevel4
...
class TargetRef(RootModel[TargetRef5 | TargetRef6 | TargetRef7 | TargetRef8]):
    root: TargetRef5 | TargetRef6 | TargetRef7 | TargetRef8 = Field(
        ..., description="Relationship target domains, including legitimate unresolved targets."
    )


class TerminalOutcome4(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    status: Literal["ok"]
...
class TerminalOutcome5(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ConfigurationDifference(
    RootModel[
        ...
        | ConfigurationDifference9
        | ConfigurationDifference10
        | ConfigurationDifference11
        | ConfigurationDifference12
        | ConfigurationDifference13
        | ConfigurationDifference14
    ]
):
    root: (
        ConfigurationDifference8
...
class ExecutionPayload5(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ExecutionPayload6(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ExecutionTarget5(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    artifact_id: str
...
class ExecutionTarget4(RootModel[ExecutionTarget5 | ExecutionTarget | ExecutionTarget7]):
    root: ExecutionTarget5 | ExecutionTarget | ExecutionTarget7
...
class ReadArtifactRequest(BaseModel):
    ...
    section: ArtifactSection6 | None = Field(
        ...,
...
class ResearchRequest21(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchRequest23(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchRequest25(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchRequest26(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchRequest27(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchRequest29(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchSelection6(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ResearchSelection(RootModel[ResearchSelection5 | ResearchSelection6]):
    root: ResearchSelection5 | ResearchSelection6 = Field(
        ...,
...
class SemanticQuery(BaseModel):
    ...
    hover: str | None
    limitations: list[str]
    locations: list[ExecutionTarget4]
...
class AlternativeValue4(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ExecutionPayload4(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class ExecutionPayload(RootModel[ExecutionPayload4 | ExecutionPayload5 | ExecutionPayload6]):
    root: ExecutionPayload4 | ExecutionPayload5 | ExecutionPayload6
...
class ResearchRequest24(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
...
class TerminalOutcome6(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
    )
    error: Error
...
class TerminalOutcome(RootModel[TerminalOutcome4 | TerminalOutcome5 | TerminalOutcome6]):
    root: TerminalOutcome4 | TerminalOutcome5 | TerminalOutcome6 = Field(
        ...,
